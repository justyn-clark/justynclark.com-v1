...
<ul class="header-menu">
	...
	<li> <a href="/portfolio"><i class="fi-folder"></i>Portfolio</a>
		...
		<li>
		<a href="/photo-portfolio" title="Photography" class="featured">
		<i class="fi-camera">
		</i>Photography</a>
		</li>
		<li>
		<a href="/video-portfolio" title="Video" class="featured">
		<i class="fi-video">
		</i>Video</a>
		</li>
		<li>
		<a href="/website-portfolio" title="Websites" class="featured">
		<i class="fi-laptop">
		</i>Websites</a>
		</li>
		<li>
		<a href="/branding-portfolio" title="Branding" class="featured">
		<i class="fi-lightbulb">
		</i>Branding</a>
		</li>
		<li>
		<a href="/graphic-design-portfolio" title="Graphic Design" class="featured">
		<i class="fi-photo">
		</i>Graphic Design</a>
		</li>
		</ul>
