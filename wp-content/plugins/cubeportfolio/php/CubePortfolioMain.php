...
class CubePortfolioMain {
    ...
    {
        echo '<div id="cbpw-init-lightbox"></div><script type="text/javascript">jQuery(".cbp-slider").find(".cbp-slider-item").addClass("cbp-item");jQuery(".cbp-slider").cubeportfolio({layoutMode: "slider", mediaQueries: [{width: 1, cols: 1 }], gapHorizontal: 0, gapVertical: 0, caption: "", ratioAuto: true});</script>';
    }
